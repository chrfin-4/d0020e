...
public class IMG2Sprite : MonoBehaviour {
    ...
    /*
     * pixelsPerUnit = number of pixels per one unit in world space
     * pivot = the center of the sprite relative to the rectangle
     * meshType = FullRect (as-is) or Tight (tries to crop transparent pixels)
     */
